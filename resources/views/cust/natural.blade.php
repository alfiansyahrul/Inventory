     ...
     <div class="container">
       <div class="row">
         ...
         <div class="col-7 main-content ml-4">
           ...
           <input type="submit" class="btn btn-primary float-right button-edit " value="Edit" > <br>
           <div class="row">
           <div class="col">
             <form>

               <input class="form-control text-center my-3 nm" type="text" value="Member Name" readonly>
               <input class="form-control text-center my-3 eml" type="text" value="Email" readonly>
               <input class="form-control text-center my-3 pt" type="text" value="Member Points" readonly>


           </div>
           <div class="col">
             <textarea class="form-control my-4 almt" rows="5" value="addres" readonly > address member </textarea>
       ...
       function sending_ajax(){
         $.ajax({
           ...
           success:function(result){
            console.log(result);
            $('.nm').val(result.data.name);
            $('.eml').val(result.data.email);
            $('.almt').val(result.data.address);
            $('.pt').val(result.data.point);
           }
         });
       }
